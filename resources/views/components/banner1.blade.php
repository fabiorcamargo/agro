<div class="relative bg-white overflow-hidden">
    <div class="max-w-screen mx-auto">
        ...
        <div class="relative z-10 pb-8 bg-gradient-to-r from-green1 from-10% to-green2 to-90% sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32"
            x-data="{ open: false }">
            <svg class="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-white transform translate-x-1/2"
                fill="#003020" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h2
                        ...
                        {{-- {{request()->input('cidade') ? 'Vagas em ' . request()->input('cidade') : "" }} --}}
                        {{env('BANNER_SLOGAN1')}}
                        <br class="xl:hidden" />
                        <span class="text-white">{{env('BANNER_SLOGAN2')}}</span>
                        <span class="text-green3 pe-0">Agronegócio</span>
                    </h2>
                    <p
                        class="my-8 text-base text-white sm:mt-5 sm:text-lg sm:max-w-xl sm:leading-7 sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        {{env('BANNER_DESC')}} {{request()->input('cidade') ? request()->input('cidade') : "Sua Cidade" }} {{" - "}} {{request()->input('uf') ? request()->input('uf') : "" }}
                    </p>

                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        <div class="rounded-md shadow">
                            <a href="#cadastro"
                                class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-black leading-6 font-medium rounded-md bg-gray-300 hover:bg-green-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                                {{env('BANNER_BUTTON1')}}
                            </a>
                        </div>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-full">
        <img src="/BG Agro.jpg" alt="{{env('APP_NAME')}}"
...
<div class="mx-auto max-w-5xl  sm:px-6 m-[-20px] lg:px-8 ">
    <div
        class="transition duration-500 hover:scale-105 lg:hover:scale-110 relative isolate overflow-hidden bg-green2 px-6 py-16 shadow-2xl sm:rounded-3xl sm:px-16 md:py-16 lg:flex lg:gap-x-20 lg:px-24 lg:py-0 z-30">
        ...
        <div class="mx-auto text-center lg:mx-0 lg:flex-auto lg:py-10 lg:text-left">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-300">Introdução ao Agronegócio: Descubra a base de tudo e como você pode se destacar neste setor dinâmico.
                ...
                Técnica de Vendas e Importação/Exportação.</p>
