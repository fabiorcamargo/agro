          ...
          <div id="region-main-box">
              <section id="region-main" aria-label="Conteúdo">
                  ...
                  <div class="activity-header" data-for="page-activity-header">
                      ...
                      <div data-region="activity-information" data-activityname="Política de Privacidade" class="activity-information">
                      </div>
                  </div>
                  <div role="main" id="yui_3_18_1_1_1712801953981_20">
                      <div class="box py-3 generalbox center clearfix" id="yui_3_18_1_1_1712801953981_19">
                          <div class="no-overflow" id="yui_3_18_1_1_1712801953981_18">
                              ...
                              <p><b>(Realizar pergunta de múltipla escolha com opção outras)</b></p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Quando o usuário cria uma conta/perfil na plataforma Jovem Aprendiz Agronegócio: esses dados são os dados de identificação básicos, como e-mail, nome completo, cidade de residência e profissão. A partir deles, podemos identificar o usuário e o visitante, além de garantir uma maior segurança e bem-estar às suas necessidade. Ficam cientes os usuários e visitantes de que seu perfil na plataforma estará acessível a todos demais usuários e visitantes da plataforma Jovem Aprendiz Agronegócio.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Quando um usuário e visitante acessa OU páginas do site Jovem Aprendiz Agronegócio &nbsp;OU o aplicativo Jovem Aprendiz Agronegócio: as informações sobre interação e acesso são coletadas pela empresa para garantir uma melhor experiência ao usuário e visitante. Estes dados podem tratar sobre as palavras-chaves utilizadas em uma busca, o compartilhamento de um documento específico, comentários, visualizações de páginas, perfis, a URL de onde o usuário e visitante provêm, o navegador que utilizam e seus IPs de acesso, dentre outras que poderão ser armazenadas e retidas.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Por intermédio de terceiro: a plataforma Jovem Aprendiz Agronegócio recebe dados de terceiros, como Facebook e Google, quando um usuário faz login com o seu perfil de um desses sites. A utilização desses dados é autorizada previamente pelos usuários junto ao terceiro em questão.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->outras</p>
                              ...
                              <p><b>(Realizar pergunta de múltipla escolha com opção outras)</b></p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados para a criação da conta/perfil na plataforma e-mail, nome completo, cidade de residência e profissão.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados para otimização da navegação: acesso a páginas, palavras-chave utilizadas na busca, recomendações, comentários, interação com outros perfis e usuários, perfis seguidos, endereço de IP.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados para concretizar transações: dados referentes ao pagamento e transações, tais como, número do cartão de crédito e outras informações sobre o cartão, além dos pagamentos efetuados.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Newsletter: o e-mail cadastrado pelo visitante que optar por se inscrever na Newsletter será coletado e armazenado até que o usuário solicite o descadastro.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados sensíveis: a plataforma poderá coletar os seguintes dados sensíveis do usuário como origem étnica ou racial, opinião política, convicção religiosa, dados genéticos, dados relativos à saúde, orientação sexual.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados relacionados a contratos: diante da formalização do contrato de compra e venda ou de prestação de serviços entre a plataforma e o usuário e visitante poderão ser coletados e armazenados dados relativos a execução contratual, inclusive as comunicações realizada entre a empresa e o usuário.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->outras</p>
                              <p><b>SEÇÃO 3 - PARA QUE FINALIDADES UTILIZAMOS OS DADOS PESSOAIS DO USUÁRIO E VISITANTE?</b></p>
                              <p><b>(Realizar questão múltipla escolha com outras)</b></p>
                              <p>Os dados pessoais do usuário e do visitante coletados e armazenados pela plataforma Jovem Aprendiz Agronegócio tem por finalidade:</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Bem-estar do usuário e visitante: aprimorar o produto e/ou serviço oferecido, facilitar, agilizar e cumprir os compromissos estabelecidos entre o usuário e a empresa, melhorar a experiência dos usuários e fornecer funcionalidades específicas a depender das características básicas do usuário.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Melhorias da plataforma: compreender como o usuário utiliza os serviços da plataforma, para ajudar no desenvolvimento de negócios e técnicas.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Anúncios: apresentar anúncios personalizados para o usuário com base nos dados fornecidos.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Comercial: os dados são usados para personalizar o conteúdo oferecido e gerar subsídio à plataforma para a melhora da qualidade no funcionamento dos serviços.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Previsão do perfil do usuário: tratamento automatizados de dados pessoais para avaliar o uso na plataforma.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados de cadastro: para permitir o acesso do usuário a determinados conteúdos da plataforma, exclusivo para usuários cadastrados</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Dados de contrato: conferir às partes segurança jurídica e facilitar a conclusão do negócio.</p>
                              <p><!--[if !supportLists]-->·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--[endif]-->Outras</p>
                              ...
                              <p>Os dados pessoais (não) podem ser compartilhados (com terceiros) (com as seguintes pessoas (físicas) (jurídicas): 42.866.959/0001-54.</p>
                              <p><b>(Se os dados podem ser compartilhados)</b></p>
                              ...
                              <p><b>(Se transferência para outros países)</b></p>
                              ...
                              <p>O usuário e o visitante da plataforma Jovem Aprendiz Agronegócio &nbsp;manifesta conhecer e aceitar que pode ser utilizado um sistema de coleta de dados de navegação mediante à utilização de cookies.</p>
